 ...
 */
final class Version20220510102136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE noticia CHANGE fecha_pub fecha_pub DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE noticia CHANGE fecha_pub fecha_pub DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
